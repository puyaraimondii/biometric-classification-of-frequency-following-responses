...
flags = tf.app.flags
flags.DEFINE_string('data_path_retest', '/home/bruce/Dropbox/Project/6.Result/data_spectrogram/EFR/85_time_4096_rename/retest/', 'data files path')
flags.DEFINE_string('data_path_test', '/home/bruce/Dropbox/Project/6.Result/data_spectrogram/EFR/85_time_4096_rename/test/', 'data files path')
# for mac os
...
# print ('data_r.shape is: ', data_r.shape)
'''
