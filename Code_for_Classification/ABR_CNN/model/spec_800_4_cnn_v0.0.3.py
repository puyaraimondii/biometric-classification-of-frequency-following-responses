...
# model construction
model = Sequential()
model.add(Conv2D(64, kernel_size=(100, 4), padding='same', activation='relu', kernel_regularizer=l2(l=0.0005), bias_regularizer=l2(l=0.0005), input_shape=input_shape))  # kernel size is filter matrix size
model.add(Conv2D(64, kernel_size=(10, 1), padding='same', activation='relu', kernel_regularizer=l2(l=0.0005), bias_regularizer=l2(l=0.0005)))
