...
num_classes = 22
epochs = 300
spec_rows, spec_cols = 800, 4


# data
# the data, shuffled and split between train and test sets
data_r = np.load('/home/bruce/Dropbox/Project/5.Code_Example/ABR_CNN/data/spec_800_4/data_r.npy')
data_t = np.load('/home/bruce/Dropbox/Project/5.Code_Example/ABR_CNN/data/spec_800_4/data_t.npy')
label_r = np.load('/home/bruce/Dropbox/Project/5.Code_Example/ABR_CNN/data/spec_800_4/label_r.npy')
label_t = np.load('/home/bruce/Dropbox/Project/5.Code_Example/ABR_CNN/data/spec_800_4/label_t.npy')
...
# model construction
model = Sequential()
model.add(Conv2D(32, kernel_size=(100, 1), padding='same', activation='relu', kernel_regularizer=l2(l=0.0005), bias_regularizer=l2(l=0.0005), input_shape=input_shape))  # kernel size is filter matrix size
model.add(Conv2D(32, kernel_size=(10, 4), padding='same', activation='relu', kernel_regularizer=l2(l=0.0005), bias_regularizer=l2(l=0.0005)))
