...
flags = tf.app.flags
flags.DEFINE_string('data_path', '/home/bruce/Dropbox/4.Project/6.Result/data_spectrogram/EFR/85_800_4_rename/', 'data files path')
# for mac os
flags.DEFINE_string('record', '/home/bruce/Dropbox/4.Project/6.Result/data_spectrogram/EFR/EFR_85_spectrum_v009.tfrecord', 'record output path')
FLAGS = flags.FLAGS
...
flags = tf.app.flags
flags.DEFINE_string('data_path_retest', '/home/bruce/Dropbox/4.Project/6.Result/data_spectrogram/EFR/85_melspectrogram_22_9_rename/retest/', 'data files path')
flags.DEFINE_string('data_path_test', '/home/bruce/Dropbox/4.Project/6.Result/data_spectrogram/EFR/85_melspectrogram_22_9_rename/test/', 'data files path')
FLAGS = flags.FLAGS
...
np.save('../data/mel_22_9/data_r', data_r)
np.save('../data/mel_22_9/label_r', label_r)
np.save('../data/mel_22_9/data_t', data_t)
np.save('../data/mel_22_9/label_t', label_t)
