...
flags = tf.app.flags
flags.DEFINE_string('data_path', '/home/bruce/Dropbox/4.Project/6.Result/data_spectrogram/EFR/85_melspectrogram_22_33_rename/', 'data files path')
# for mac os
flags.DEFINE_string('record', '/home/bruce/Dropbox/4.Project/6.Result/data_spectrogram/EFR/EFR_85_spectrum_v010.tfrecord', 'record output path')
FLAGS = flags.FLAGS

save_path = '/home/bruce/Dropbox/4.Project/5.Code_Example/ABR_CNN/data/'
...
np.save('../data/mel_22_33/data_r', data_r)
np.save('../data/mel_22_33/label_r', label_r)
np.save('../data/mel_22_33/data_t', data_t)
np.save('../data/mel_22_33/label_t', label_t)
