...
flags = tf.app.flags
flags.DEFINE_string('data_path_retest', '/home/bruce/Dropbox/Project/6.Result/data_spectrogram/EFR/85_800_rename/retest/', 'data files path')
flags.DEFINE_string('data_path_test', '/home/bruce/Dropbox/Project/6.Result/data_spectrogram/EFR/85_800_rename/test/', 'data files path')
FLAGS = flags.FLAGS
...
np.save('../data/spec_800_31/data_r', data_r)
np.save('../data/spec_800_31/label_r', label_r)
np.save('../data/spec_800_31/data_t', data_t)
np.save('../data/spec_800_31/label_t', label_t)
