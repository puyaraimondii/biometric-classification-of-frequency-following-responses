...
#T14R14 T14R9
axs6[0,0].plot(x2_label_concat, r14_as_85_aenu, label='retest14')
axs6[0,0].plot(x2_label_concat, t14_as_85_aenu, label='test14')
axs6[0,0].legend(loc='upper right')
axs6[0,0].set_title('s14_as_85_aenu (0.832793, rank#3)')
axs6[0,0].set_xlim(0,535) # 0 to 1300 Hz

axs6[0,1].plot(x2_label_concat, r9_as_85_aenu, label='retest9')
axs6[0,1].plot(x2_label_concat, t14_as_85_aenu, label='test14')
axs6[0,1].legend(loc='upper right')
axs6[0,1].set_title('r9_as_85_aenu vs t14_as_85_aenu (0.835228, rank#1)')
axs6[0,1].set_xlim(0,535) # 0 to 1300 Hz

# T15R15 T15R1
axs6[1,0].plot(x2_label_concat, r15_as_85_aenu, label='retest15')
axs6[1,0].plot(x2_label_concat, t15_as_85_aenu, label='test15')
axs6[1,0].legend(loc='upper right')
axs6[1,0].set_title('s15_as_85_aenu (0.845387, rank#4)')
axs6[1,0].set_xlim(0,535) # 0 to 1300 Hz

axs6[1,1].plot(x2_label_concat, r1_as_85_aenu, label='retest1')
axs6[1,1].plot(x2_label_concat, t15_as_85_aenu, label='test15')
axs6[1,1].legend(loc='upper right')
axs6[1,1].set_title('r1_as_85_aenu vs. t15_as_85_aenu (0.89756, rank#1)')
axs6[1,1].set_xlim(0,535) # 0 to 1300 Hz
plt.show()

# Subject 20 21
fig7, axs7 = plt.subplots(2, 2)
# T20R20 T20R1
axs7[0,0].plot(x2_label_concat, r20_as_85_aenu, label='retest20')
axs7[0,0].plot(x2_label_concat, t20_as_85_aenu, label='test20')
axs7[0,0].legend(loc='upper right')
axs7[0,0].set_title('s20_as_85_aenu (0.844889, rank#7)')
axs7[0,0].set_xlim(0,535) # 0 to 1300 Hz

axs7[0,1].plot(x2_label_concat, r1_as_85_aenu, label='retest1')
axs7[0,1].plot(x2_label_concat, t20_as_85_aenu, label='test20')
axs7[0,1].legend(loc='upper right')
axs7[0,1].set_title('r1_as_85_aenu vs t20_as_85_aenu (0.905874, rank#1)')
axs7[0,1].set_xlim(0,535) # 0 to 1300 Hz
# T21R21 T21R7
axs7[1,0].plot(x2_label_concat, r21_as_85_aenu, label='retest21')
axs7[1,0].plot(x2_label_concat, t21_as_85_aenu, label='test21')
axs7[1,0].legend(loc='upper right')
axs7[1,0].set_title('s21_as_85_aenu (0.815956, rank#2)')
axs7[1,0].set_xlim(0,535) # 0 to 1300 Hz

axs7[1,1].plot(x2_label_concat, r7_as_85_aenu, label='retest7')
axs7[1,1].plot(x2_label_concat, t21_as_85_aenu, label='test21')
axs7[1,1].legend(loc='upper right')
axs7[1,1].set_title('r7_as_85_aenu vs. t21_as_85_aenu (0.820878, rank#1)')
axs7[1,1].set_xlim(0,535) # 0 to 1300 Hz
plt.show()
