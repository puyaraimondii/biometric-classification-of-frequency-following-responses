...
# as7_aenu 
temp7 = pd.concat([df_as7_85.iloc[0:44, 0:7].reset_index(drop=True), df_as7_85.iloc[44:88, 0:7].reset_index(drop=True)], axis=1)
temp8 = pd.concat([df_as7_85.iloc[88:132, 0:7].reset_index(drop=True), df_as7_85.iloc[132:176, 0:7].reset_index(drop=True)], axis=1)
df_as7_aenu_85 = pd.concat([temp7, temp8], axis=1, ignore_index=True)

temp9 = pd.concat([df_as7_win_85.iloc[0:44, 0:7].reset_index(drop=True), df_as7_win_85.iloc[44:88, 0:7].reset_index(drop=True)], axis=1)
temp10 = pd.concat([df_as7_win_85.iloc[88:132, 0:7].reset_index(drop=True), df_as7_win_85.iloc[132:176, 0:7].reset_index(drop=True)], axis=1)
