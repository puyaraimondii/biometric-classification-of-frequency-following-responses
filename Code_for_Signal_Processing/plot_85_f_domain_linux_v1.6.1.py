...
df_EFR_avg_85_data_normbystd = (df_EFR_avg_85_data.iloc[:, :1024]).div(df_EFR_avg_85_data_std, axis=0)
# normalize the dataframe by 
df_EFR_avg_85_data_sumofsquare = (np.square(df_EFR_avg_85_data.iloc[:, :1024])).sum(axis=1)
df_EFR_avg_85_data_normbysumofsquare = (df_EFR_avg_85_data.iloc[:, :1024]).div(df_EFR_avg_85_data_sumofsquare, axis=0)


df_EFR_avg_85_withzero = pd.concat([df_EFR_avg_85_data, df_EFR_avg_85_mid, df_EFR_avg_85_label], axis=1)
df_EFR_avg_85_normbystd_withzero = pd.concat([df_EFR_avg_85_data_normbystd, df_EFR_avg_85_mid, df_EFR_avg_85_label], axis=1)
df_EFR_avg_85_normbysumofsquare_withzero = pd.concat([df_EFR_avg_85_data_normbysumofsquare, df_EFR_avg_85_mid, df_EFR_avg_85_label], axis=1)
# rename columns
df_EFR_avg_85_withzero.columns = np.append(np.arange(96060), ["Subject", "Sex", "Condition", "Vowel", "Sound Level", "Num", "EFR/FFR"])
df_EFR_avg_85_normbystd_withzero.columns = np.append(np.arange(96060), ["Subject", "Sex", "Condition", "Vowel", "Sound Level", "Num", "EFR/FFR"])
df_EFR_avg_85_normbysumofsquare_withzero.columns = np.append(np.arange(96060), ["Subject", "Sex", "Condition", "Vowel", "Sound Level", "Num", "EFR/FFR"])
...
df_normbystd_cx_85 = pd.DataFrame()
df_normbysumofsquare_cx_85 = pd.DataFrame()
...
for i in range(176):
    ...
    temp_cx2 = (fftpack.fft(df_EFR_avg_85_normbystd_withzero.iloc[i, 0:96060])/n2)[range(int(n2/2))]
    df_normbystd_cx_85 = df_normbystd_cx_85.append(pd.DataFrame(temp_cx2.reshape(1,48030)), ignore_index = True)
    
    temp_cx3 = (fftpack.fft(df_EFR_avg_85_normbysumofsquare_withzero.iloc[i, 0:96060])/n2)[range(int(n2/2))]
    df_normbysumofsquare_cx_85 = df_normbysumofsquare_cx_85.append(pd.DataFrame(temp_cx3.reshape(1,48030)), ignore_index = True)
...
df_normbystd_cx_85 = pd.concat([df_normbystd_cx_85, df_EFR_avg_85_label], axis=1) # add labels on it
df_normbysumofsquare_cx_85 = pd.concat([df_normbysumofsquare_cx_85, df_EFR_avg_85_label], axis=1) # add labels on it
...
df_normbystd_cx_85_vsc = df_normbystd_cx_85.sort_values(by=["Vowel", "Subject", "Condition"])
df_normbystd_cx_85_vsc = df_normbystd_cx_85_vsc.reset_index(drop=True)
df_normbystd_cx_85_vsc_label = df_normbystd_cx_85_vsc.iloc[:,48030:]

df_normbysumofsquare_cx_85_vsc = df_normbysumofsquare_cx_85.sort_values(by=["Vowel", "Subject", "Condition"])
df_normbysumofsquare_cx_85_vsc = df_normbysumofsquare_cx_85_vsc.reset_index(drop=True)
df_normbysumofsquare_cx_85_vsc_label = df_normbysumofsquare_cx_85_vsc.iloc[:,48030:]
...
# normalize df_cx_85_vsc but didn't change the name (root mean square)
df_cx_85_vsc = df_cx_85_vsc.iloc[:, :48030].div(((np.square(df_cx_85_vsc.iloc[:, :48030].abs())).sum(1).div(48030)).pow(1/2), axis=0)
df_cx_win_85_vsc = df_cx_win_85_vsc.iloc[:, :48030].div(((np.square(df_cx_win_85_vsc.iloc[:, :48030].abs())).sum(1).div(48030)).pow(1/2), axis=0)

df_normbystd_cx_85_vsc = df_normbystd_cx_85_vsc.iloc[:, :48030].div(((np.square(df_normbystd_cx_85_vsc.iloc[:, :48030].abs())).sum(1).div(48030)).pow(1/2), axis=0)
df_normbystd_cx_win_85_vsc = df_cx_win_85_vsc.iloc[:, :48030].div(((np.square(df_cx_win_85_vsc.iloc[:, :48030].abs())).sum(1).div(48030)).pow(1/2), axis=0)

df_normbysumofsquare_cx_85_vsc = df_normbysumofsquare_cx_85_vsc.iloc[:, :48030].div(((np.square(df_normbysumofsquare_cx_85_vsc.iloc[:, :48030].abs())).sum(1).div(48030)).pow(1/2), axis=0)
df_normbysumofsquare_cx_win_85_vsc = df_cx_win_85_vsc.iloc[:, :48030].div(((np.square(df_cx_win_85_vsc.iloc[:, :48030].abs())).sum(1).div(48030)).pow(1/2), axis=0)
...
df_normbystd_cx_85_vsc_a = df_normbystd_cx_85_vsc.iloc[0:44, :].reset_index(drop=True)
df_normbystd_cx_85_vsc_e = df_normbystd_cx_85_vsc.iloc[44:88, :].reset_index(drop=True)
df_normbystd_cx_85_vsc_n = df_normbystd_cx_85_vsc.iloc[88:132, :].reset_index(drop=True)
df_normbystd_cx_85_vsc_u = df_normbystd_cx_85_vsc.iloc[132:176, :].reset_index(drop=True)

df_normbysumofsquare_cx_85_vsc_a = df_normbysumofsquare_cx_85_vsc.iloc[0:44, :].reset_index(drop=True)
df_normbysumofsquare_cx_85_vsc_e = df_normbysumofsquare_cx_85_vsc.iloc[44:88, :].reset_index(drop=True)
df_normbysumofsquare_cx_85_vsc_n = df_normbysumofsquare_cx_85_vsc.iloc[88:132, :].reset_index(drop=True)
df_normbysumofsquare_cx_85_vsc_u = df_normbysumofsquare_cx_85_vsc.iloc[132:176, :].reset_index(drop=True)
...
distance_normbystd_cx_85_vsc_a, distance_normbystd_cx_85_vsc_a_square = distance_mx(df_normbystd_cx_85_vsc_a)
distance_normbystd_cx_85_vsc_e, distance_normbystd_cx_85_vsc_e_square = distance_mx(df_normbystd_cx_85_vsc_e)
distance_normbystd_cx_85_vsc_n, distance_normbystd_cx_85_vsc_n_square = distance_mx(df_normbystd_cx_85_vsc_n)
distance_normbystd_cx_85_vsc_u, distance_normbystd_cx_85_vsc_u_square = distance_mx(df_normbystd_cx_85_vsc_u)

distance_normbysumofsquare_cx_85_vsc_a, distance_normbysumofsquare_cx_85_vsc_a_square = distance_mx(df_normbysumofsquare_cx_85_vsc_a)
distance_normbysumofsquare_cx_85_vsc_e, distance_normbysumofsquare_cx_85_vsc_e_square = distance_mx(df_normbysumofsquare_cx_85_vsc_e)
distance_normbysumofsquare_cx_85_vsc_n, distance_normbysumofsquare_cx_85_vsc_n_square = distance_mx(df_normbysumofsquare_cx_85_vsc_n)
distance_normbysumofsquare_cx_85_vsc_u, distance_normbysumofsquare_cx_85_vsc_u_square = distance_mx(df_normbysumofsquare_cx_85_vsc_u)
...
# normbystd
correlation_matrix_min_01_comb(distance_normbystd_cx_85_vsc_a,\
                               distance_normbystd_cx_85_vsc_a_square,\
                               cm_title1='std normed distance_cx_85_vsc_a(smallest) euclidian format',\
                               cm_title2='std normed distance_cx_85_vsc_a(smallest) square')

correlation_matrix_min_01_comb(distance_normbystd_cx_85_vsc_e,\
                               distance_normbystd_cx_85_vsc_e_square,\
                               cm_title1='std normed distance_cx_85_vsc_e(smallest) euclidian format',\
                               cm_title2='std normed distance_cx_85_vsc_e(smallest) square')

correlation_matrix_min_01_comb(distance_normbystd_cx_85_vsc_n,\
                               distance_normbystd_cx_85_vsc_n_square,\
                               cm_title1='std normed distance_cx_85_vsc_n(smallest) euclidian format',\
                               cm_title2='std normed distance_cx_85_vsc_n(smallest) square')

correlation_matrix_min_01_comb(distance_normbystd_cx_85_vsc_u,\
                               distance_normbystd_cx_85_vsc_u_square,\
                               cm_title1='std normed distance_cx_85_vsc_u(smallest) euclidian format',\
                               cm_title2='std normed distance_cx_85_vsc_u(smallest) square')

# norm by sumofsquare
correlation_matrix_min_01_comb(distance_normbysumofsquare_cx_85_vsc_a,\
                               distance_normbysumofsquare_cx_85_vsc_a_square,\
                               cm_title1='sumofsquare normed distance_cx_85_vsc_a(smallest) euclidian format',\
                               cm_title2='sumofsquare normed distance_cx_85_vsc_a(smallest) square')

correlation_matrix_min_01_comb(distance_normbysumofsquare_cx_85_vsc_e,\
                               distance_normbysumofsquare_cx_85_vsc_e_square,\
                               cm_title1='sumofsquare normed distance_cx_85_vsc_e(smallest) euclidian format',\
                               cm_title2='sumofsquare normed distance_cx_85_vsc_e(smallest) square')

correlation_matrix_min_01_comb(distance_normbysumofsquare_cx_85_vsc_n,\
                               distance_normbysumofsquare_cx_85_vsc_n_square,\
                               cm_title1='sumofsquare normed distance_cx_85_vsc_n(smallest) euclidian format',\
                               cm_title2='sumofsquare normed distance_cx_85_vsc_n(smallest) square')

correlation_matrix_min_01_comb(distance_normbysumofsquare_cx_85_vsc_u,\
                               distance_normbysumofsquare_cx_85_vsc_u_square,\
                               cm_title1='sumofsquare normed distance_cx_85_vsc_u(smallest) euclidian format',\
                               cm_title2='sumofsquare normed distance_cx_85_vsc_u(smallest) square')
