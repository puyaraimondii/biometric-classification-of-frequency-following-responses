...
def correlation_matrix_comb(corr_mx, cm_title):  
    ...
    im2 = ax2.matshow(corr_mx, cmap=plt.cm.Wistia)
    # colorbar need numpy version 1.13.1
...
# concatenate AENU
frames = [df_EFR_avg_85.iloc[0:44, 0:1024], df_EFR_avg_85.iloc[44:88, 0:1024], df_EFR_avg_85.iloc[88:132, 0:1024], df_EFR_avg_85.iloc[132:176, 0:1024]]
df_EFR_avg_85_aenu = pd.concat(frames, axis=1, join_axes=[df_EFR_avg_85.iloc[0:44, 0:1024].index])
