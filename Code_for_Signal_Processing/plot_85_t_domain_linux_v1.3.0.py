...
df_EFR=pd.read_pickle('/home/bruce/Dropbox/Code/ABR/3.Code for Linux/df_EFR.pkl')
...
for i in range(704):
    ...
    # no window function
    df_EFR_avg_t = pd.DataFrame(df_EFR_avg_t.iloc[0,:].values.reshape(1,1024))
    # implement the window function
    #df_EFR_avg_t = pd.DataFrame((df_EFR_avg_t.iloc[0,:] * win_hamming).values.reshape(1,1024))
...
df_EFR_avg_85_vsc = df_EFR_avg_85.sort_values(by=["Vowel", "Subject", "Condition"])
#df_EFR_avg_85_vsc = df_EFR_avg_85.sort_values(by=["Vowel", "Subject"])
df_EFR_avg_85_vsc = df_EFR_avg_85_vsc.reset_index(drop=True)
df_EFR_avg_85_vsc_label = df_EFR_avg_85_vsc.iloc[:, 1024:]

df_EFR_avg_85_vsc_a = df_EFR_avg_85_vsc.iloc[0:44, :]
df_EFR_avg_85_vsc_e = df_EFR_avg_85_vsc.iloc[44:88, :]
df_EFR_avg_85_vsc_n = df_EFR_avg_85_vsc.iloc[88:132, :]
df_EFR_avg_85_vsc_u = df_EFR_avg_85_vsc.iloc[132:176, :]
...
fig_t_in_1(df_EFR_avg_85_vsc_a, title = '85dB a vowel subjects in time domain', \
           path = '/home/bruce/Dropbox/Code/ABR/4.Result/4.Result_Nov/1.time_domain/', \
           filename = '85_a_t_domain.png')
fig_t_in_1(df_EFR_avg_85_vsc_e, title = '85dB e vowel subjects in time domain', \
           path = '/home/bruce/Dropbox/Code/ABR/4.Result/4.Result_Nov/1.time_domain/', \
           filename = '85_e_t_domain.png')
fig_t_in_1(df_EFR_avg_85_vsc_n, title = '85dB n vowel subjects in time domain', \
           path = '/home/bruce/Dropbox/Code/ABR/4.Result/4.Result_Nov/1.time_domain/', \
           filename = '85_n_t_domain.png')
fig_t_in_1(df_EFR_avg_85_vsc_u, title = '85dB u vowel subjects in time domain', \
           path = '/home/bruce/Dropbox/Code/ABR/4.Result/4.Result_Nov/1.time_domain/', \
